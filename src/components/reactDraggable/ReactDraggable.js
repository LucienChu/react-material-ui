...
export default class ReactDraggable extends React.Component {
  ...
  render() {
    const dragHandlers = {
      onStart: () => console.log("onStart call back from draggable"),
      onStop: () => console.log("onStop call back from draggable"),
    };
    ...
    return (
      <div>
        ...
        <Draggable cancel="h1" {...dragHandlers}>
          <div className="box">
            <strong className="no-cursor">Can't drag here</strong>
            <h1>Dragging here works</h1>
          </div>
        </Draggable>
